...
"""The python2dev plugin can be used for python 2 based parts.
It is the same as the python2 plugin except it allows python-dev to be loaded
...
class Python2devPlugin(snapcraft.BasePlugin):
